      ...
      <div class="card mt-4">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" name="nama-costumer" class="form-control" id="nama-costumer"
              placeholder="Masukan Nama Costumer" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="jangka-waktu" class="form-control" id="jangka-waktu"
              placeholder="Masukan Jangka Waktu Sewa dalam Hari" required>
          </div>
          <div class="mb-3">
            <label for="harga-sewa" class="form-label">Harga Sewa</label>
            <input type="text" name="harga-sewa" class="form-control" id="harga-sewa"
              placeholder="Masukan Harga Sewa dalam Jumblah Angka" required>
          </div>
          <div class="mb-3">
            <label for="total-bayar" class="form-label">Total Bayar</label>
            <input type="text" name="total-bayar" class="form-control" id="total-bayar"
              placeholder="Masukan Jumblah total bayar" required>
          </div>
          <div class="mb-3 text-left">
            <label for="status-bayar" class="form-label ">Status Bayar</label>
            <select class="form-select" name="status-bayar" aria-label="Default select example" id="status-bayar"
              required>
